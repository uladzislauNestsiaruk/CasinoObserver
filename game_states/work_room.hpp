...
private:
    ...
    friend void BlackjackScreenHandler(StateManager* manager, IGameState* state, const json& data);
    friend void PokerScreenHandler(StateManager* manager, IGameState* state, const json& data);
};
